...
shooter.punch_object = function(object, tool_caps, dir, on_blast, shooter)
	...
	if do_damage then
		...
		for k, v in pairs(groups) do
			...
			--	classes.change_xp(shooter, tool_caps.damage_groups[k])
			--end
		end
		
		print(shooter:get_player_name())
		object:punch(shooter, nil, tool_caps, dir)
		return true
	end
end
...
local function process_hit(pointed_thing, spec, dir)
	...
	elseif pointed_thing.type == "object" then
		...
		shooter.punch_object(object, spec.tool_caps, dir, nil, spec.shooter) then
