...
minetest.register_tool("frontier_tools:tin_shovel", {
    description = "Tin Shovel",
    inventory_image = "frontier_tools_tin_shovel.png",
	wield_image = "frontier_tools_tin_shovel.png^[transformR90",
    tool_capabilities = {
		full_punch_interval = 1.0,
		max_drop_level=0,
		groupcaps={
			crumbly = {times={[1]=1.65, [2]=1.05, [3]=0.45}, uses=14, maxlevel=1},
		},
		damage_groups = {fleshy=2},
	},
	sound = {breaks = "default_tool_breaks"},
...
minetest.register_tool("frontier_tools:tin_axe", {
	description = "Tin Axe",
	inventory_image = "frontier_tools_tin_axe.png",
	tool_capabilities = {
		full_punch_interval = 0.9,
		max_drop_level=0,
		groupcaps={
			choppy={times={[1]=2.75, [2]=1.70, [3]=1.15}, uses=14, maxlevel=1},
		},
		damage_groups = {fleshy=3},
	},
	sound = {breaks = "frontier_tools_breaks"},
})
...
minetest.register_tool("frontier_tools:tin_knife", {
	description = "Tin Knife",
	inventory_image = "frontier_tools_tin_knife.png",
	tool_capabilities = {
		full_punch_interval = 0.6,
		max_drop_level = 1,
		groupcaps = {
			snappy = {times={[1]=3.0, [2]=2.2, [3]=1.4}, uses=12, maxlevel=3},
		},
		damage_groups = {fleshy = 3},
	},
	sound = {breaks = "default_tool_breaks"},
...
minetest.register_tool("frontier_tools:steel_knife", {
	...
	tool_capabilities = {
		...
		max_drop_level = 1,
		groupcaps = {
			snappy = {times={[1]=3.2, [2]=2.4, [3]=1.6}, uses = 60, maxlevel=3},
		},
		damage_groups = {fleshy = 4},
	},
	sound = {breaks = "default_tool_breaks"},
...
farming.register_hoe("frontier_tools:tin_hoe", {
    description = "Tin Hoe",
    inventory_image = "frontier_tools_tin_hoe.png",
    max_uses = 30
})
